...
import { getUserProfile } from '../utility/playlistSetting';
...
const Login: React.FC = () => {
  ...
  return (
    <div className="login-app text-center">
      <hr />
      <h2>Wanna make your own playlist?</h2>
      <div className="wrapper-login">
        <a href={getSpotifyLinkAuthorize()} className="btn btn-login text-white btn-light text-center">
          ...
          <span className="text-login">Login with Spotify</span>
        </a>
      </div>
    </div>
  );
