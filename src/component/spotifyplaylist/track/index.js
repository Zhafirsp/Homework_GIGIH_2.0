...
// const Albums = ({album, images, artist, title, toggleSelect}) => {
...
//                 </svg>
//               </button>
//               <button className={`btn btn-lg text-white mb-3 ${isSelected ? 'btn-success' : 'btn-secondary'}`} type="button" id="info" onClick={handleSelect}>
